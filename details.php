...
<label class="col-md-5 control-label" >الشكل : </label>
...
<label class="col-md-5 control-label" >  اللون </label>
...
<p class='price'>
 ...
 <del> $pro_price IQD </del>  : السعر <br>

 $pro_psp_price IQD : السعر الحالي 
...
<p class='price'>  $pro_price IQD : السعر 
...
<i class="fa fa-shopping-cart" ></i> أضافة الى السلة

</button>

<button class="btn btn-warning" type="submit" name="add_wishlist">

<i class="fa fa-heart" ></i> اضافة الى المفضلة
...
<i class='fa fa-shopping-cart'></i> اضافة الى السلة

...
<p class="text-muted" > لديك <?php echo $count; ?> عنصر في سلتك </p>
...
<input class="btn btn-primary" type="submit" name="apply_coupon" value="تأكيد الرمز" >
...
<i class="fa fa-chevron-left"></i> الاستمرار بالشراء
...
<i class="fa fa-refresh"></i> تحديث السلة

</button>

<a href="checkout.php" class="btn btn-success">

اكمال الدفع <i class="fa fa-chevron-right"></i>
...
<p class="text-muted">
يتم احتساب تكاليف الشحن والتكاليف الإضافية بناءً على القيم التي أدخلتها.
</p>

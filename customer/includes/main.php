...
if(!isset($_SESSION['customer_email'])){
  ...
  { 
      echo '<a href="/ecommerce-website-php/customer/my_account.php?my_orders" class="login__link">حسابي</a>';
  }   
?>  
</li>
...
?>  
    ...
    <div class="page-header__bottomline">
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="/ecommerce-website-php/">
        ...
        <nav class="main-nav">
          ...
          <i class="icon-basket"></i>
            ...
            <li class="categories__item">
              <a class="categories__link" href="/ecommerce-website-php/shop.php">
                الاكثر مبيعاً
              </a>
              </li>
            ...
            <li class="categories__item">
              <a class="categories__link categories__link--active" href="/ecommerce-website-php/shop.php">
             جميع المنتجات
              </a>
            </li>
